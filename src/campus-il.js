...
window.onload = () => {
    ...
    <div style="display: flex; background-color: #6e6ea7;">
        <div style="margin-right: auto; margin-left: auto;">
            <div data-font-size="16" data-font-size-type="px" dir="rtl" style="text-align: center; height: auto; padding-top: 10px; padding-bottom: 10px; display: flex; justify-items: center; align-items: center; color: white; font-weight: bold; margin-left: auto; margin-right: auto; padding-right: 15px; padding-left: 15px; width: 100%;">
